...
public class hardball extends Actor
{
	...
	Texture txtup=new Texture(Gdx.files.internal("hard/hardbrick1.png"));
	...
	*/
 txtup=new Texture(Gdx.files.internal("hard/hardbrick2.png"));
