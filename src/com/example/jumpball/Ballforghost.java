...
public class Ballforghost extends Actor
{
	...
	public static float RBorder=(340*MainActivity.w+160*3*MainActivity.w-64*MainActivity.w);
	public static float DBorder=100*MainActivity.h;
	public static float UBorder=(100*MainActivity.h+160*3*MainActivity.h-64*MainActivity.h);
	//图片宽度
	...
	Texture txtup=new Texture(Gdx.files.internal("ghost/ghost_Brick_1.png"));
	...
	*/
 txtup=new Texture(Gdx.files.internal("ghost/ghost_Brick_2.png"));
