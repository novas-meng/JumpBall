...
public class crazyball extends Actor
{
	// static ImageButton left1,up1,down1,right1,left2,up2,down2,right2,left3,up3,down3,right3;
	 ...
	 public static float LBorder=400*MainActivity.w;
		public static float RBorder=(400*MainActivity.w+160*MainActivity.w*3-64*MainActivity.w);
	...
	Texture txtup=new Texture(Gdx.files.internal("crazy/crazybrick1.png"));
 ...
 txtup=new Texture(Gdx.files.internal("crazy/crazybrick2.png"));
