...
public class ImageAdapter extends BaseAdapter 
{
	...
	public Integer[] imgs = { R.drawable.easy, R.drawable.hard, R.drawable.crazy,
							  R.drawable.crow,R.drawable.ghost,R.drawable.roll,R.drawable.bluetooth};
	public String[] titles = { "简单", "困难", "分裂", "乌鸦","幽灵","转盘","蓝牙"};
	...
	public boolean createReflectedImages() 
	{
		...
		for (Map<String, Object> map : list) {
			...
			float scale1=400/(float)width;
			Matrix sMatrix = new Matrix();
			//sMatrix.postScale(1, 1);
			...
			imageView.setLayoutParams(new GalleryView.LayoutParams((int)(width * scale+50),
